...
'==================================================================
    ...
    Const COL_DATE As String = "E"
    Const COL_CHANNEL As String = "H"
    ...
    Const FILTER_MONTH As Long = 0     '0 = YTD, 1-12 = Month
    Const FILTER_CHANNEL As String = "" 'Blank = All Channels

    Const DEST_QTY As String = "BV"
    Const DEST_REV As String = "BW"
    Const DEST_GP As String = "BX"
...
'==================================================================
    ...
    arr = wsSource.Range(wsSource.Cells(2, ColLetterToNum(COL_CODE)), _
                         wsSource.Cells(lastSource, ColLetterToNum(COL_GP))).Value

    For i = 1 To UBound(arr, 1)

        saleDate = wsSource.Cells(i + 1, ColLetterToNum(COL_DATE)).Value
        channel = UCase(Trim(CStr(wsSource.Cells(i + 1, ColLetterToNum(COL_CHANNEL)).Value)))

        If Year(saleDate) <> REPORT_YEAR Then GoTo NextRow

        If FILTER_MONTH > 0 Then
            If Month(saleDate) <> FILTER_MONTH Then GoTo NextRow
        End If
